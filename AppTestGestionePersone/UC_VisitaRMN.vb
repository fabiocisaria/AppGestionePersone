...
Public Class UC_VisitaRMN
    ...
    Private Sub ComboBoxQuantita_CheckedChanged(sender As Object, e As EventArgs) Handles ComboBoxEsito.SelectedIndexChanged
        ...
        If selezioneOK Then
            ...
            Try
                ...
                Else
                    ...
                    queryRMN = "INSERT INTO VisitaSintomi (
                                                    ID_Visita,
                                                    DataRMN,
                                                    EsitoRMN,
