...
Public Class UC_Terapia
    ...
    Private Async Function CercaFarmaciAsync(idTerapia As Integer) As Task(Of List(Of (ID As Integer, Nome As String)))
    ...
    Private Async Function CercaTerapieRiabilitativeAsync(idTerapia As Integer) As Task(Of List(Of (ID As Integer, Nome As String)))
    ...
    Private Async Function CercaVisitaAsync() As Task(Of Boolean)
        ...
        If dtCheckTerapia.Rows.Count = 1 Then
            ...
            Dim farmaci As List(Of (ID As Integer, Nome As String)) = Await CercaFarmaciAsync(idTerapia)
            ...
            Dim terapie As List(Of (ID As Integer, Nome As String)) = Await CercaTerapieRiabilitativeAsync(idTerapia)
    ...
    Private Sub CaricaFarmacoPanel(id As Integer, nomeFarmaco As String)
        ...
        Dim lbl As New Label With {
            ...
            .ForeColor = Theme.FarmaciPanelForeColor,
        ...
        AddHandler tlp.MouseEnter, Sub()
                                       lbl.ForeColor = Theme.FarmaciPanelHoveredForeColor
                                   End Sub
        AddHandler tlp.MouseLeave, Sub()
                                       lbl.ForeColor = Theme.FarmaciPanelForeColor
                                   End Sub
        AddHandler btnX.MouseEnter, Sub()
                                        lbl.ForeColor = Theme.FarmaciPanelHoveredForeColor
                                        btnX.ForeColor = Theme.FarmaciPanelDeleteForeColor
                                    End Sub
        AddHandler btnX.MouseLeave, Sub()
                                        lbl.ForeColor = Theme.FarmaciPanelForeColor
                                        btnX.ForeColor = Theme.FarmaciPanelForeColor
                                    End Sub
    ...
    .Anchor = AnchorStyles.None
        ...
        ' Effetto hover
        AddHandler tlp.MouseEnter, Sub()
                                       lbl.ForeColor = Theme.TerapiePanelHoveredForeColor
                                   End Sub
        AddHandler tlp.MouseLeave, Sub()
                                       lbl.ForeColor = Theme.TerapiePanelForeColor
                                   End Sub
        AddHandler btnX.MouseEnter, Sub()
                                        lbl.ForeColor = Theme.TerapiePanelHoveredForeColor
                                        btnX.ForeColor = Theme.TerapiePanelDeleteForeColor

                                    End Sub
        AddHandler btnX.MouseLeave, Sub()
                                        lbl.ForeColor = Theme.TerapiePanelForeColor
                                        btnX.ForeColor = Theme.TerapiePanelForeColor
                                    End Sub
        AddHandler lbl.MouseEnter, Sub()
                                       lbl.ForeColor = Theme.TerapiePanelHoveredForeColor
                                   End Sub
