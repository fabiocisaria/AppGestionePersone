...
Public Class UC_VisitaUroGineco
    ...
    Private Async Function CercaVisitaAsync() As Task(Of Boolean)
        ...
        If dtCheck.Rows.Count = 1 And dtSwabCheck.Rows.Count = 1 Then
            ...
            ' Ipercontrattilità
            If dettagliVisita("Ipercontrattilita") = "Assente" Then
                RadioButtonContrA.Checked = True
            ElseIf dettagliVisita("Ipercontrattilita") = "Lieve" Then
            ...
            If dettagliVisita("CitalgiaProvocata") = True Then
                MetroToggleCistProv.Checked = True
            Else
                MetroToggleCistProv.Checked = False
            End If
    ...
    Private Async Function SalvaDatiAsync() As Task(Of Boolean)
        ...
        If selezioneOK Then
            ...
            Dim ipercontrattilita As String = GetSelectedRadioText(TableLayoutPanelIpercontratt)

            Dim cistProv As Boolean = MetroToggleCistProv.Checked
    ...
    Private Async Sub Inserici_Click(sender As Object, e As EventArgs) Handles ButtonInserisci.Click
        ...
        If esito Then
            ...
            TableLayoutPanelVisitaUroGineco.Enabled = True
        Else
            main.MostraToast("Errore nel salvataggio dei dati ..." & vbCrLf & "Controllare di aver compilato tutti i campi")
        End If
    End Sub
End Class
